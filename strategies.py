...
def greedy_maxCover_minus_hd_hcfbc(graph, n):
    high_seeds = set(highest_degree(graph, n))
    high_seeds.update(highest_current_flow_betweenness_centrality(graph, n))
    greedy_seeds = greedy_maxCover(graph, 2 * n)
...
def greedy_maxCover_minus_hd_hsc(graph, n):
    high_seeds = set(highest_degree(graph, n))
    high_seeds.update(highest_subgraph_centrality(graph, n))
    greedy_seeds = greedy_maxCover(graph, 2 * n)
...
def greedy_maxCover_minus_hd_hsc_hcfbc(graph, n):
    high_seeds = set(highest_degree(graph, n))
    high_seeds.update(highest_subgraph_centrality(graph, n))
    high_seeds.update(highest_current_flow_betweenness_centrality(graph, n))
    greedy_seeds = greedy_maxCover(graph, 2 * n)
...
def greedy_maxCover_minus_hsc_hcfbc(graph, n):
    high_seeds = set(highest_subgraph_centrality(graph, n))
    high_seeds.update(highest_current_flow_betweenness_centrality(graph, n))
    greedy_seeds = greedy_maxCover(graph, 2 * n)
...
def get_strats(scope, n_players=2):
    ...
    if scope == "team":
        return [
            ...
            greedy_maxCover_minus_hd_hsc_hcfbc,
            greedy_maxCover_minus_hd_hcfbc,
            greedy_maxCover_minus_hd_hsc,
            greedy_maxCover_minus_hsc_hcfbc
